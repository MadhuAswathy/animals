...
<body>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="row">
                <div class="col col-12 col-md-12 col-sm-12 col-xl-12 col xxl-12">
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img src="images/front1.jpg" class="d-block w-100" alt="..." height="500" width="800"> 
                                  </div>
